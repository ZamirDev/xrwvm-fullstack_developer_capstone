...
ALLOWED_HOSTS = [
    'localhost',
    'zamirmemon01-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai'
]

CSRF_TRUSTED_ORIGINS = [
    'https://zamirmemon01-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai'
]
